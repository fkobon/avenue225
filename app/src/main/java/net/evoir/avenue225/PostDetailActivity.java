    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onPageSelected(int position) {
        	...
        	try {
                ...
                //decrease number of unread post for Category
                    catDao = Model.getHelper(mContext).getDao(Category.class);
                    postCategory = catDao.queryForId(post.getCategorySlug());
                    if (null!=postCategory){
                        postCategory.setNumber(mContext,postCategory.getNumber()-1);
                    }
                }
